function Stacks() {
    ...
    return(
        ...
        <div className='relative flex items-start justify-self-start w-96 h-96 '>
                                    <div className='absolute opacity-75 bg-cyan-600 z-10 inset-0 -translate-x-72 translate-y-12 transform rotate-45 rounded-lg' ></div>
                                    <div className='absolute opacity-60 bg-cyan-600 z-20 inset-0 -translate-x-64 -translate-y-6 transform rotate-45 rounded-lg' ></div>
                                    ...
                                    <div className='absolute opacity-85 bg-cyan-600 z-30 inset-0 transform rotate-45 rounded-lg translate-x-72' ></div>
                                </div>
        </>
    )
}
